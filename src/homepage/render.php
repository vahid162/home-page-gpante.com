...
function gpante_home_build_context(): array {
    return [
        ...
        'sale_products' => gpante_home_get_sale_products( 3 ),
        'new_products'  => gpante_home_get_new_products( 6 ),
...
function gpante_home_render_main(): void {
    ...
    echo '<main class="hp hp--current-match" id="main-content" dir="rtl">';
    ...
    gpante_home_render_part( 'promo-banners', $context );
